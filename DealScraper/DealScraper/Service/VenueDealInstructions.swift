...
nonisolated enum VenueDealInstructions {
    ...
    static let verbatimRule = """
        Critical rule: never rewrite text. Every title, detail, condition, day, time, and promotion date value must be copied character-for-character as shown in the source. Do not combine lines, change capitalization, fix spelling, expand abbreviations, or paraphrase.
        """
