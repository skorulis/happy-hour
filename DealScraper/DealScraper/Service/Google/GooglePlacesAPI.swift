...
enum GooglePlacesAPI {
    ...
    nonisolated static let placeFieldMask =
        "places.id,places.displayName,places.location,places.formattedAddress,places.websiteUri,places.types,places.regularOpeningHours,places.businessStatus,places.rating,places.userRatingCount"
